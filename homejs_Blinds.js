                  ...
                  webpage += "<div class='row no-gutters align-items-center'>";
                    webpage += "<div class='col '>";
                      ...
                      webpage += "<div class='card-body mx-auto col-6'>";
                        webpage += "<a class='btn btn-primary btn-block' onclick='"+'sendBTN_async_update("upL")'+"'><i class='fas fa-chevron-up'></i></a>";
                        webpage += "<a class='btn btn-primary btn-block' onclick='"+'sendBTN_async_update("stopL")'+"'><i class='fas fa-minus'></i></a>";
                        webpage += "<a class='btn btn-primary btn-block' onclick='"+'sendBTN_async_update("downL")'+"'><i class='fas fa-chevron-down'></i></a>";
                      webpage += "</div>";
